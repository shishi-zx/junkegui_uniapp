<template>
    <div class="container">
        ...
        <div class="list-box">
            <uni-list class="list">
                <my-link :to="`{ path: '/pages/martyr/information', query: { id: ${item.id},type:1 }}`" navType="push"
...
<script>
import { reqAllMartyr,reqDelMartyr } from '../../api/index'
export default {
    data() {
        return {
            list: [],
    ...
    methods: {
        ...
        onAddOne(){
            this.$Router.push({ path: '/pages/martyr/information', query: { type: 2 }})
        }
    },
    onShow() {
        this.init()
