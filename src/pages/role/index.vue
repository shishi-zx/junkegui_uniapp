<template>
    <div class="container">
        ...
        <div class="list-box">
            <uni-list class="list">
                <my-link :to="`{ path: '/pages/role/information', query: { id: ${item.id},type:1 }}`" navType="push"
                    v-for="(item, index) in list" :key="index">
                    <uni-list-item ellipsis="2" :title="item.nameZh">
...
export default {
    ...
    methods: {
        ...
        onAddOne(){
            this.$Router.push({ path: '/pages/role/information', query: { type: 2 }})
        }
    },
    onShow() {
        this.init()
