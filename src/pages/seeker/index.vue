<template>
    <div class="container">
        ...
        <div class="list-box">
            <uni-list class="list">
                <my-link :to="`{ path: '/pages/seeker/information', query: { id: ${item.id},type:1 }}`" navType="push"
...
<script>
import { reqAllSeeker,reqDelSeeker } from '../../api/index'
export default {
    data() {
        return {
            list: [],
    ...
    methods: {
        ...
        onAddOne(){
            this.$Router.push({ path: '/pages/seeker/information', query: { type: 2 }})
        }
    },
    onShow() {
        this.init()
